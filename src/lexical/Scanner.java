...
public class Scanner {
  ...
  public Token nextToken() throws Exception {
    ...
    while (true) {
      ...
      switch (state) {
        ...
        case 1 -> {
          ...
          if (isLetterOrUnderscore(currentChar) || isDigit(currentChar)) {
            content.append(currentChar);
              ...
              || isParentheses(currentChar)
              || isComment(currentChar)) {
        ...
        case 2 -> {
          ...
          if (isDigit(currentChar)) {
            ...
            this.state = 3;
              ...
              || isParentheses(currentChar) || isComment(currentChar)) {
            back();
        ...
        case 4 -> {
          ...
          if (isDigit(currentChar)) {
            content.append(currentChar);
              ...
              || isAttribution(currentChar) || isParentheses(currentChar) || isComment(currentChar)) {
            back();
            return new Token(TokenType.NUMBER, content.toString());
          } else {
            LexicalException.badValue(this.currentChar, this.current_line, this.current_column);
        ...
        case 9 -> { 
			/*
			Estado 9 irá reconhecer os parenteses '(' ou ')'' e retornar seu tipo como delimitador
			*/
          back();
          return new Token(TokenType.DELIM, content.toString());
        }
        case 10 -> {
			/*
  ...
  private boolean isParentheses(char currentChar) {
    return (currentChar == '(' || currentChar == ')');
  }
